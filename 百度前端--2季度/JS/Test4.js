...
function init() {
  ...
  var table1 = document.getElementById('aqi-table');
  table1.addEventListener('click',function(event){
  	if (event.target.nodeName.toLowerCase()==="button") {//event.target.nodeName = BUTTON
  		var city = event.target.parentNode.previousSibling.previousSibling.innerHTML;
  		delBtnHandle(city);
  	}
  })
}
